...
class NotificationService {
  ...
  private seedInitial() {
    ...
    // Seed mock active devices for demonstration of push endpoints
    const initialDevices: DeviceRecord[] = [
      {
        id: 'dev-admin-primary',
        userId: 'admin-somesh',
        userRole: 'admin',
        userEmail: 'someshnagote14@gmail.com',
        pushToken: 'push-token-web-admin-somesh-9821a',
        platform: 'web',
      ...
      },
      {
        ...
        userRole: 'customer',
        userEmail: 'rohit.nashik@gmail.com',
        pushToken: 'push-token-android-fcm-rohit-8812',
        platform: 'android',
      ...
      {
        id: 'dev-cust-priya',
        userId: 'customer-priya-college-rd',
        userRole: 'customer',
        userEmail: 'priya.deshmukh@gmail.com',
        pushToken: 'push-token-ios-apns-priya-7721',
        platform: 'ios',
        browser: 'Safari PWA / iOS 17.5',
        permissionStatus: 'granted',
        isActive: true,
        lastActiveAt: new Date().toISOString(),
      ...
      },
      {
        ...
        userRole: 'provider',
        userEmail: 'ramesh.jadhav@urbnservices.in',
        pushToken: 'push-token-android-fcm-ramesh-9931',
        platform: 'android',
        browser: 'URBN Partner App / Android 13',
        permissionStatus: 'granted',
        isActive: true,
        lastActiveAt: new Date().toISOString(),
      ...
      },
      {
        ...
        userRole: 'provider',
        userEmail: 'suresh.patil@urbnservices.in',
        pushToken: 'push-token-android-fcm-suresh-1102',
        platform: 'android',
        browser: 'URBN Partner App / Android 14',
        permissionStatus: 'granted',
        isActive: true,
        lastActiveAt: new Date().toISOString(),
    ...
    // Seed historical and scheduled notification jobs
    const initialJobs: PushNotificationJob[] = [
      {
        id: 'job-push-101',
        title: 'Monsoon Home Care: 20% Off Drainage & AC',
        message: 'Prepare your home for Nashik rains with express monsoon waterproofing and AC deep cleaning.',
        category: 'Promotion',
        iconType: 'sparkles',
        ...
        status: 'Sent',
        createdBy: 'someshnagote14@gmail.com',
        createdAt: new Date(Date.now() - 2 * 86400000).toISOString(),
        updatedAt: new Date(Date.now() - 2 * 86400000).toISOString(),
        sentAt: new Date(Date.now() - 2 * 86400000 + 1200).toISOString(),
        stats: {
          targetUserCount: 5,
          activeDeviceCount: 5,
          deliveredCount: 5,
        ...
        deliveryLogs: [
          ...
          {
            id: 'log-2',
            timestamp: new Date(Date.now() - 2 * 86400000 + 1100).toISOString(),
            deviceId: 'dev-cust-priya',
            userId: 'customer-priya-college-rd',
            platform: 'ios',
            status: 'Delivered',
          },
      ...
      {
        id: 'job-push-102',
        title: 'Weekly Nashik Service Reliability Update',
        message: '100% of Gangapur Road & College Road bookings were delivered within 24 hours this week.',
        category: 'System',
        iconType: 'shield',
        audience: { type: 'service_areas', serviceAreas: ['Gangapur Road', 'College Road'] },
        deepLink: { type: 'home', label: 'Open URBN App' },
    ...
    // Seed sample customer inbox notifications
    const sampleInboxItems: UserInboxNotification[] = [
      {
        id: 'inbox-1',
        userId: 'customer-rohit-nashik',
        jobId: 'job-push-101',
        ...
        read: true,
        readAt: new Date(Date.now() - 2 * 86400000 + 3600000).toISOString(),
      },
      {
        id: 'inbox-2',
        userId: 'customer-rohit-nashik',
        title: 'Technician Assigned: Ramesh Jadhav',
        message: 'Ramesh Jadhav (Master Plumber) is assigned to booking UB-89421 and en route.',
        category: 'Booking',
        iconType: 'truck',
        deepLink: { type: 'active_booking', targetId: 'UB-89421', label: 'Track Live' },
    ...
    this.userInboxes.set('customer-rohit-nashik', sampleInboxItems);
  }
