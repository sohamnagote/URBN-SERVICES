...
import { AUTHORIZED_ADMIN_EMAILS, PLATFORM_COMMISSION_RATE } from '../config/constants';
...
export class BackendStore {
  ...
  public platformCommissionRate = PLATFORM_COMMISSION_RATE;
  ...
  public recordAudit(log: Omit<AuditLogRecord, 'id' | 'timestamp'>): AuditLogRecord {
