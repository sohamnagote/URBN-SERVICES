...
import { AudienceCriteria, PushNotificationJob } from '../types';

export class NotificationController {
  public registerDevice(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return res.json({ success: true, device: deviceRecord });
    } catch (err) {
      next(err);
    }
  }

  public unregisterDevice(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  public getUserInbox(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  public markUserItemRead(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  public markAllUserItemsRead(req: Request, res: Response, next: NextFunction) {
    try {
      const userId = (req.body.userId as string) || (req.headers['x-user-id'] as string) || 'customer-rohit-nashik';
  ...
  public getUserPreferences(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  public updateUserPreferences(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  public estimateAudience(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  public getJobs(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return res.json({ success: true, jobs, totalCount: jobs.length });
    } catch (err) {
      next(err);
    }
  }

  public async createJob(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  public getJobById(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  public cancelJob(req: Request, res: Response, next: NextFunction) {
    try {
      const adminEmail = (req.headers['x-admin-email'] as string) || req.body.adminEmail || 'someshnagote14@gmail.com';
      const job = notificationService.jobs.get(req.params.id);
      if (!job) {
      ...
      return res.json({ success: true, job, message: 'Notification schedule cancelled successfully.' });
    } catch (err) {
      next(err);
    }
  }

  public async sendJobNow(req: Request, res: Response, next: NextFunction) {
    try {
      const adminEmail = (req.headers['x-admin-email'] as string) || req.body.adminEmail || 'someshnagote14@gmail.com';
      const job = notificationService.jobs.get(req.params.id);
      if (!job) {
  ...
  public deleteJob(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  public async sendTest(req: Request, res: Response, next: NextFunction) {
    try {
      const adminEmail = (req.headers['x-admin-email'] as string) || req.body.adminEmail || 'someshnagote14@gmail.com';
      const result = await notificationService.sendTestNotification(req.body, adminEmail);
  ...
  public saveTemplate(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return res.json({ success: true, template: newTemplate, message: 'Template saved successfully!' });
    } catch (err) {
      next(err);
    }
  }
